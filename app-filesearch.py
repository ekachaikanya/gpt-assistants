    ...
    def on_tool_call_delta(self, delta, snapshot):
        ...
        if delta.type == "file_search":
            if delta.file_search.input:
                st.session_state.current_tool_input += delta.file_search.input
...
def create_thread(content, file):
    ...
    if file is not None:
        ...
        thread = client.beta.threads.create(  messages[0],
            tool_resources={
                "file_search": {
