...
openai_api_key= None
assistant_id="asst_Jhu1IQqWyLv2JIbol4pSkyVs"
vector_id="vs_0uVxjFIfaZboBlw2KDqaWrvh"
...
with st.form(key='my_form'):
    openai_api_key= st.text_input(label="Input OPEN AI API KEY",value=openai_api_key,type='password', key='apikey')
